<?php return array (
  ...
  array (
    ...
    'fallback_locale' => 'en',
    'faker_locale' => 'en_US',
    'key' => 'base64:hCinLfT+2gqZcEVASbM4nuPGFUypNF+fRbg3tzFTWBY=',
    'cipher' => 'AES-256-CBC',
    'maintenance' => 
    array (
      'driver' => 'file',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'eloquent',
        'model' => 'App\\Domain\\Auth\\Models\\User',
      ),
    ),
    'passwords' => 
    array (
  ...
  array (
    ...
    'path' => '/cp',
    'core_path' => 'cp/filament',
    'favicon' => 'http://localhost/cp/favicon.ico',
  ),
  'filesystems' => 
  array (
    'default' => 'local',
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/public/cp/images/category_dishes',
        'url' => 'http://localhost/cp/images/category_dishes',
        'visibility' => 'public',
        'throw' => false,
      ),
      'dishes' => 
      array (
        'driver' => 'local',
        'root' => '/var/www/public/cp/images/dishes',
        'url' => 'http://localhost/cp/images/dishes',
        'visibility' => 'public',
        'throw' => false,
      ),
      'promotions' => 
      array (
        'driver' => 'local',
        'root' => '/var/www/public/cp/images/promotions',
        'url' => 'http://localhost/cp/images/promotions',
        'visibility' => 'public',
        'throw' => false,
      ),
      's3' => 
